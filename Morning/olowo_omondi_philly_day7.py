...
with open("olowo.txt", "w") as file:
    file.write("I am Olowo and i love python.\n")
    file.write("I use python for automation")

# Reading from a text file
with open("olowo.txt", "r") as file:
    content = file.read()
    print(content)
...
student_data = {"name": "olowo", "course": "BSE", "year": "Year2"}
...
student_details = {
    "Student": {"name": "olowo philly", "age": "25", "course": "BSE", "address": "Paris"}
}
